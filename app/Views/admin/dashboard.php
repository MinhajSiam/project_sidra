<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
        <div class="glass-card rounded-2xl p-5 space-y-2 border border-slate-800">
            ...
            <div class="font-heading font-extrabold text-2xl text-white"><?= format_currency($totalRevenue) ?></div>
        ...
        <div class="glass-card rounded-2xl p-5 space-y-2 border border-slate-800">
            ...
            <div class="font-heading font-extrabold text-2xl text-white"><?= number_format($totalBookings) ?></div>
        ...
        <div class="glass-card rounded-2xl p-5 space-y-2 border border-amber-500/20 bg-amber-950/10">
            ...
            <div class="font-heading font-extrabold text-2xl text-amber-300"><?= number_format($pendingPaymentsCount) ?></div>
        ...
        <div class="glass-card rounded-2xl p-5 space-y-2 border border-slate-800">
            ...
            <div class="font-heading font-extrabold text-2xl text-white"><?= number_format($ticketsSoldCount) ?></div>
        ...
        <div class="glass-card rounded-2xl p-5 space-y-2 border border-slate-800">
            ...
            <div class="font-heading font-extrabold text-2xl text-white"><?= number_format($checkedInCount) ?></div>
